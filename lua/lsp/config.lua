...
local M = {
	-- Notification settings - set to false to disable noisy LSP messages
	notifications = {
		server_config = false, -- "Configured LSP servers" messages
		server_enable = false, -- "Enabled LSP server" messages
		server_disable = false, -- "Disabled LSP server" messages
		server_start = false, -- "Started LSP server" messages
		server_stop = false, -- "Stopped LSP server" messages
		server_restart = false, -- "Restarting LSP server" messages
