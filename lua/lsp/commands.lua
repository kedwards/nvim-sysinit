...
function M.setup()
	...
	-- local notifications = utils.lazy_require("lsp.notifications")
	--
	-- M.config = {
	--   show_attach_detach_notifications = notifications.config.show_attach_detach_notifications,
	--   show_server_notifications = notifications.config.show_server_notifications,
	--   show_config_loaded_messages = notifications.config.show_config_loaded_messages,
	-- }
	...
	-- 		M.config.show_attach_detach_notifications = not M.config.show_attach_detach_notifications
	-- 		local status = M.config.show_attach_detach_notifications and "enabled" or "disabled"
	...
	-- 		M.config.show_config_loaded_messages = not M.config.show_config_loaded_messages
	-- 		local status = M.config.show_config_loaded_messages and "enabled" or "disabled"
	...
	-- 		local new_state = not (M.config.show_attach_notifications or M.config.show_server_notifications or M.config.show_config_loaded_messages)
	-- 		M.config.show_attach_notifications = new_state
	-- 		M.config.show_server_notifications = new_state
	--     M.config.show_config_loaded_messages = new_state
	--
